...
{
    public partial class MusteriHizmetleriAdmin : Form
    {
        public MusteriHizmetleriAdmin()
        {
            InitializeComponent();
        }
        ...
        private void MusteriHizmetleriAdmin_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string kayit2 = "insert into MusteriHizmetleri(tc,ad,soyad,yetki,kullaniciAdi,parola,eMail) values (@tc,@ad,@soyad,@yetki,@kullaniciAdi,@parola,@eMail)";
                ...
                baglanti.Close();
                MessageBox.Show("Musteri Hizmetleri Kayıt İşlemi Gerçekleşti.");
                txttc.Clear();
                txtad.Clear();
                txtsoyad.Clear();
                txtyetki.Clear();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (cevap == DialogResult.Yes)
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("delete from MusteriHizmetleri where id=@aid", baglanti);
        ...
        private void kayitGetir()
        {
            ...
            baglanti.Open();
            string kayit = "SELECT * from MusteriHizmetleri";
            SqlCommand komut = new SqlCommand(kayit, baglanti);
        ...
        {
            baglanti.Open();
            string kayit = "update MusteriHizmetleri set tcNo=@tcNo,ad=@ad,soyad=@soyad,yetki=@yetki,kullaniciAdi=@kullaniciAdi,parola=@parola,eMail=@eMail where tcNo=@tcNo";
            SqlCommand komut = new SqlCommand(kayit, baglanti);
            komut.Parameters.AddWithValue("@tcNo", txttc.Text);
            komut.Parameters.AddWithValue("@ad", txtad.Text);
            komut.Parameters.AddWithValue("@soyad", txtsoyad.Text);
            ...
            komut.ExecuteNonQuery();
            baglanti.Close();
            MessageBox.Show("Muşteri Hizmetleri Bilgileri Güncellendi.");
        }
